<x-guest-layout>
    ...
    <section class="mt-20">
        <div class="flex items-center justify-center">
            ...
            Marriage Registraion Certificate
        </h1>
        </div>
    </section>
    ...
    <div class="max-w-7xl mx-auto md:px-6 mt-5 grid sm:grid-cols-3">
        ...
        <div class="sm:col-span-2 mt-3 bg-white/50 backdrop-blur-md border border-white/30 rounded-xl py-8 shadow p-16">
            ...
            <p class="text-gray-700 mb-6 leading-relaxed text-justify">
                Marriage Registraion Certificate is an essential document which is mostly required by embassies for processing visa alongwith other use cases. It is issued on basis of basic marriage contract i.e. nikahnama (for muslims) or any other base document for other communities. In order to obtain a Marriage Registraion Certificate from ICT Administration, visit the Citizen Facilitation Center, G-11/4, Islamabad. Here is the step-by-step process.
            </p>

            <div class="space-y-4">
                <div class="">
                    <h3 class="font-semibold text-lg text-gray-900">Step One:-</h3>
                    <p class="ml-5">Check your eligiblty to apply for MRC from ICT:-</p>
                    <ul class="ml-5 list-disc pl-5 text-gray-700">
                        <li class="text-justify">Marriage should be registered by a registrar of Sectorial area of Islamabad.</li>
                        <li class="text-justify">In case, marriage is registered in rural area of Islamabad or any other region of Pakistan, the applicant should apply to conerned union councel</li>
                        <li class="text-justify">As per Law, at the time of marriage, the bride age should not be less than 18 years </li>
                        
                    </ul>
                    <h3 class="font-semibold text-lg text-gray-900 mt-2">Step Two:-</h3>
                    <p class="ml-5">Required documents:-</p>
                    <ul class="ml-5 list-disc pl-5 text-gray-700">    
                        <li class="text-justify">Copy of CNICs of Groom and Bride</li>
                        <li class="text-justify">Copy of CNICs of Fathers of Groom and Bride</li>
        ...
        <div id="search" class="col-span-1 mt-3">
            <div class="bg-white/50 backdrop-blur-md border border-white/30 rounded-xl sm:mx-5 p-6 shadow ">
                <h2 class="text-xl font-bold text-gray-900 mb-4">Check MRC Status</h2>
                ...
                @if(session('status'))
                    ...
                    <div class="mt-4 bg-{{$class_type}}-100 border border-{{$class_type}}-400 text-{{$class_type}}-700 px-4 py-3 rounded">
                        <h3 class="font-semibold text-lg text-center">MRC Status</h3>
