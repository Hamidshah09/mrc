<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto p-6 bg-white shadow-md rounded mt-10">
        ...
        @endif
        <form method="POST" action="{{ route('noc-ict.update', $letter->Letter_ID) }}">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="date" name="letter[Letter_Date]"
                           ...
                           value="{{ old('letter.Letter_Date', optional($letter)->Letter_Date ? date('Y-m-d', strtotime($letter->Letter_Date)) : '') }}">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="letter[Letter_Sent_to]"
                           class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"
                           value="{{ old('letter.Letter_Sent_to', $letter->Letter_Sent_to) }}">
                </div>
