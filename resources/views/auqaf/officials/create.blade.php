<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto p-6 bg-white shadow-md rounded mt-10">
        ...
        <form action="{{ route('auqaf-officials.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select name="type"
                        ...
                        <option value="Shrine" {{ old('type') == 'Shrine' ? 'selected' : '' }}>Shrine</option>
                ...
                <div>
                    ...
                    <select name="mousque_id"
                        ...
                        @foreach ($mousques as $mosque)
                            <option value="{{ $mosque->id }}"
                                {{ old('mousque_id') == $mosque->id ? 'selected' : '' }}>
