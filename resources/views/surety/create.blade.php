<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto mt-10 bg-white p-6 rounded-lg shadow-lg">
            ...
            <div class="border overflow-auto" style="height: 200px;">
                ...
                @if(in_array($ext, ['jpg','jpeg','png']))
                    <img id="docImage"
                         ...
                         class="mx-auto transform scale-100 transition">
                @else
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            <h2 class="text-xl font-bold mb-4 text-gray-700">Enter Record</h2>
    ...
    <script>
        ...
        function zoomIn() {
            scale += 0.1;
            document.getElementById('docImage').style.transform = `scale(${scale})`;
        }
