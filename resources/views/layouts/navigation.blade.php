                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <div class="relative" x-data="{ dropdown: false }">
                            ...
                            <div x-show="dropdown" @click.outside="dropdown = false"
                                x-transition
                                class="absolute mt-2 w-56 bg-white shadow-lg rounded-lg z-50">
                                <a href="{{route('drc.index')}}" class="block px-4 py-2 hover:bg-gray-100">Arbitration Cases</a>
                                <a href="{{route('drc.live.create')}}" class="block px-4 py-2 hover:bg-gray-100">Create New Case</a>
                                <a href="{{route('drc.old.create')}}" class="block px-4 py-2 hover:bg-gray-100">Create Old Case</a>
                            </div>
                        </div>
                    </div>
                @endif
